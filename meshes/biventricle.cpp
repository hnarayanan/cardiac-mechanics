...
void load_parameters()
{
    ...
    r_angle_endo = boost::lexical_cast<int>(pt.get<std::string>("right_ventricle.angle_endo"));
    r_angle_epi = boost::lexical_cast<int>(pt.get<std::string>("right_ventricle.angle_epi"));
...
int main()
{
	...
	if (i >= 180 - r_angle_endo && i <= 180 + r_angle_endo)
	{
	...
	if (i >= 180 - r_angle_epi && i <= 180 + r_angle_epi)
	{
